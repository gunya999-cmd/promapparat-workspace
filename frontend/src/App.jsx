...
export default function App(){
 ...
 const navigate=value=>{setSection(protectedSections.has(value)&&!isAdmin?'opportunities':value);setSelectedId(null)};
