...
import{Bell,ClipboardPlus,Command,Search,ShieldCheck,UserRound}from'lucide-react';
...
export function CommandBar({works,users,currentUser,onOpenWork,onAddTender,onSwitchRole,section}){
