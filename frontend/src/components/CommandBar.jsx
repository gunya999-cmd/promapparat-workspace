...
export function CommandBar({works,users,currentUser,onOpenWork,onAddTender,onSwitchRole,onLogout,serverManaged=false,syncState='',onReload,section}){
