...
import{BriefcaseBusiness,Building2,Calculator,Compass,Landmark,Plus,Search,Settings,ShieldCheck,Table2,TrendingUp,UserRound,Zap}from'lucide-react';
 ...
 return <aside className="rail">
  ...
  <div className="rail-nav">
   {isDirector?<>
    ...
    <button className={section==='works'?'active':''} onClick={()=>setSection('works')}><BriefcaseBusiness/>Мои сделки</button>
    <button className={section==='suppliers'?'active':''} onClick={()=>setSection('suppliers')}><Building2/>Поставщики</button>
   </>}
  </div>
