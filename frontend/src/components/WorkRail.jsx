...
import{BriefcaseBusiness,Building2,Calculator,LayoutDashboard,Plus,Search,ShieldCheck,Zap}from'lucide-react';
...
export function WorkRail({works,activeId,onSelect,onNew,query,setQuery,section,setSection,currentUser,isAdmin}){
 return <aside className="rail">
  ...
  <div className="rail-section-note"><ShieldCheck/><b>{currentUser?.name||'Пользователь'}</b><span>{isAdmin?'Администратор':'Пользователь системы'}</span></div>
 </aside>;
}