...
describe('formula lifecycle',()=>{
 ...
 it('rejects formula roles not wired to the engine',()=>{const formula={...createManualFormula(),role:'logistics',expression:'=A2',inputs:[{ref:'A2',value:100}]};expect(()=>publishFormula(formula,{id:'admin'})).toThrow('не подключено к рабочему расчету')});
